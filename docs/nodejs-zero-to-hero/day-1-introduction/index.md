...
- **Setup** — [ติดตั้ง NVM (Node Version Manager)](./nvm.md): ติดตั้งและสลับเวอร์ชัน Node.js ให้ตรงกับโปรเจกต์/ทีม
- **Part 1** — [Day 1: Core Concepts for Beginners](./core-concepts.md): ปูพื้นเรื่องโปรแกรม, Request/Response, Terminal, โครงสร้างไฟล์, Express และการแยก Client/Server
- **Part 2** — [Day 1: JavaScript Fundamentals](./javascript-fundamentals/): ตัวแปร, ประเภทข้อมูล, Operators, Functions, Arrow Functions, Array Methods, Loops และ Conditional Logic
- **Part 3** — [Day 1: Git Basics](./git-basics.md): ทำความเข้าใจ Version Control, คำสั่ง Git สำคัญ, แนวคิด commit prefix และการตั้งชื่อ branch
- **Part 4** — [Day 1: Hands-on Labs](./hands-on-labs.md): Workshop ตั้งค่าโฟลเดอร์, เขียน `hello-library.js`, และทำ Git commit แรก
...
### 4.4 ฟังก์ชัน (Functions): ชุดคำสั่งที่ใช้ซ้ำได้
