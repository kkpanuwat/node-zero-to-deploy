---
id: day-2-node-express-quickstart
title: 'Day 2 (Short): Node.js + Express.js Quickstart (CommonJS)'
sidebar_label: 'Node + Express (80m)'
description: 'เวอร์ชันย่อ 80 นาที: รัน node, เข้าใจ package.json, ใช้ npm ติดตั้งแพ็กเกจ, และสร้าง Express server แรก (CommonJS)'
---

# Day 2 (Short): เริ่มต้น Node.js + Express.js (ทำ API แรก) — 80 นาที
